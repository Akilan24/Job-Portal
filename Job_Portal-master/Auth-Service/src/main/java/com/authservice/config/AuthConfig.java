...
import com.authservice.utility.TokenFilterApplicant;
import com.authservice.utility.TokenFilterRecruiter;
...
public class AuthConfig {
	...
	@Autowired
	TokenFilterApplicant tokenFilterApplicant;
	@Autowired
	TokenFilterRecruiter tokenFilterRecruiter;
	@Autowired
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.cors().configurationSource(new CorsConfigurationSource() {
			...
			public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
				...
				.requestMatchers("/JP/Auth/**").permitAll().anyRequest().authenticated().and().sessionManagement()
