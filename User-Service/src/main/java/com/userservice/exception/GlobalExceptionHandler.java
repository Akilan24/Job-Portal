...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleException(ApplicantNotFoundException ex, WebRequest request) {
	...
	public ResponseEntity<ErrorResponse> handleException(RecruiterNotFoundException ex, WebRequest request) {
